...
import com.duyp.architecture.clean.android.powergit.ui.helper.NameParser;
...
public class GithubHelper {
    ...
    @NonNull private static String parseReadme(@NonNull String source, @NonNull String baseUrl, boolean isWiki) {
        ...
        String owner = nameParser.username;
        String repoName = nameParser.name;
    ...
    @NonNull private static String getCodeStyle(@NonNull Context context, boolean isDark) {
        ...
        return "<style>\n" +
                ...
                (PrefGetter.getThemeType(context) == PrefGetter.AMLOD ? "border: solid 1px " + accentColor + " " +
                        "!important;\n" : "") +
                "}\n" +
                "</style>";
    }
