package com.duyp.architecture.clean.android.powergit.ui.provider.markdown;
...
import com.duyp.architecture.clean.android.powergit.ui.helper.HtmlHelper;
import com.duyp.architecture.clean.android.powergit.ui.helper.InputHelper;
import com.duyp.architecture.clean.android.powergit.ui.provider.markdown.extension.emoji.EmojiExtension;
import com.duyp.architecture.clean.android.powergit.ui.provider.markdown.extension.mention.MentionExtension;
    ...
    protected static void render(@NonNull TextView textView, String markdown, int width) {
        ...
        try {
            ...
            String rendered = HtmlRenderer
                    ...
                    .build()
                    .render(node);
            HtmlHelper.htmlIntoTextView(textView, rendered, (width - (textView.getPaddingStart() + textView
                    .getPaddingEnd())));
