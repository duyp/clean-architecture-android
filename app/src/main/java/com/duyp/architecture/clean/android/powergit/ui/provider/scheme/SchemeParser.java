package com.duyp.architecture.clean.android.powergit.ui.provider.scheme;
...
import com.duyp.architecture.clean.android.powergit.ui.helper.ActivityHelper;
...
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.API_AUTHORITY;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.HOST_DEFAULT;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.HOST_GISTS;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.HOST_GISTS_RAW;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.IGNORED_LIST;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.PROTOCOL_HTTPS;
import static com.duyp.architecture.clean.android.powergit.ui.provider.scheme.LinkParserHelper.RAW_AUTHORITY;
...
public class SchemeParser {
    ...
    public static void launchUri(@NonNull Context context, @NonNull Uri data, boolean showRepoBtn, boolean newDocument) {
        ...
        if (intent != null) {
            intent.putExtra(BundleConstants.SCHEME_URL, data.toString());
            if (newDocument) {
...
//            }
            ...
            if (TextUtils.equals(authority, HOST_DEFAULT) || TextUtils.equals(authority, RAW_AUTHORITY) ||
                ...
                Optional<Intent> intentOptional = LinkParserHelper.returnNonNull(trending, projects, userIntent, repoIssues, repoPulls,
                ...
                if (intentOptional != null && intentOptional.isPresent() && intentOptional != empty) {
                    ...
                    if (isEnterprise) {
                        if (intent.getExtras() != null) {
                            ...
                            bundle.putBoolean(BundleConstants.IS_ENTERPRISE, true);
                            intent.putExtras(bundle);
                        } else {
                            intent.putExtra(BundleConstants.IS_ENTERPRISE, true);
                        }
                    }
                    return intent;
                } else {
...
//        }
    ...
    @Nullable private static Intent getGeneralRepo(@NonNull Context context, @NonNull Uri uri) {
        ...
        //    return null;
        //}
        //boolean isEnterprise = PrefGetter.isEnterprise() && Uri.parse(LinkParserHelper.getEndpoint(PrefGetter
        //        .getEnterpriseUrl())).getAuthority()
