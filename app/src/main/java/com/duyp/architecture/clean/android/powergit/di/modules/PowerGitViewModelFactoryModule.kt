 ...
 * our own implementation: [PowerGitViewModelFactory].
 */
@Module
abstract class PowerGitViewModelFactoryModule {

    @Binds
    internal abstract fun bindViewModelFactory(factory: PowerGitViewModelFactory): ViewModelProvider.Factory
}
